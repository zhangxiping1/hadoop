 ...
 */
public class TestZKStateStoreMembershipState extends TestZKStateStoreBase {
    ...
    private MembershipState createRegistration(String ns, String nn,
                                               String router,String RPC, FederationNamenodeServiceState state) throws IOException {
        MembershipState record = MembershipState.newInstance(
                router, ns,
                nn, "testcluster", "testblock-" + ns, RPC,
                "testservice-"+ ns + nn, "testlifeline-"+ ns + nn,
                "http", "testweb-" + ns + nn, state, false);
        return record;
    }
    ...
    public void testRegistrationNoQuorum()
        ...
        MembershipState report1 = createRegistration(
                "hz-cluster11", "nn_1_2", "hadoop3568.jd.163.org_8023","hadoop3898.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report1));
        Thread.sleep(100);

        MembershipState report3 = createRegistration(
                "hz-cluster11", "nn_1_2", "hadoop3898.jd.163.org_8023","hadoop3898.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report3));
        Thread.sleep(100);
        MembershipState report4 = createRegistration(
                "hz-cluster11", "nn_1_2", "hadoop3899.jd.163.org_8023","hadoop3898.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report4));

        MembershipState report2 = createRegistration(
                "hz-cluster11", "nn_1_2", "hadoop3897.jd.163.org_8023","hadoop3898.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report2));
        Thread.sleep(100);

        MembershipState report6 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3897.jd.163.org_8023","hadoop3897.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report6));
        Thread.sleep(100);
        MembershipState report7 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3898.jd.163.org_8023","hadoop3897.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report7));
        Thread.sleep(100);
        MembershipState report8 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3899.jd.163.org_8023","hadoop3897.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report8));
        MembershipState report5 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3568.jd.163.org_8023","hadoop3897.jd.163.org:8020",
                FederationNamenodeServiceState.EXPIRED);
        assertTrue(namenodeHeartbeat(report5));
        Thread.sleep(100);
        assertTrue(getStateStore().loadCache(MembershipStore.class, true));
    ...
    @Test
    public void testRegistrationNoQuorum2()
            throws InterruptedException, IOException {
//        MembershipState report1 = createRegistration(
//                "hz-cluster11", "nn_1_2", "hadoop3568.jd.163.org_8023","hadoop3898.jd.163.org:8020",
...
//        assertTrue(namenodeHeartbeat(report4));
        ...
        MembershipState report6 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3897.jd.163.org_8023","hadoop3897.jd.163.org:8025",
                FederationNamenodeServiceState.STANDBY);
        assertTrue(namenodeHeartbeat(report6));
        Thread.sleep(100);
        MembershipState report7 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3898.jd.163.org_8023","hadoop3897.jd.163.org:8025",
                FederationNamenodeServiceState.STANDBY);
        assertTrue(namenodeHeartbeat(report7));
        Thread.sleep(100);
        MembershipState report8 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3899.jd.163.org_8023","hadoop3897.jd.163.org:8025",
                FederationNamenodeServiceState.STANDBY);
        assertTrue(namenodeHeartbeat(report8));
        MembershipState report5 = createRegistration(
                "hz-cluster11", "nn_1_1", "hadoop3568.jd.163.org_8023","hadoop3897.jd.163.org:8025",
                FederationNamenodeServiceState.UNAVAILABLE);
        assertTrue(namenodeHeartbeat(report5));

//        MembershipState report10 = createRegistration(
//                "hz-cluster11", "nn_1_2", "hadoop3897.jd.163.org_8020","hadoop3898.jd.163.org:8020",
//                FederationNamenodeServiceState.STANDBY);
//        assertTrue(namenodeHeartbeat(report10));
//
//        //改完router端口
//        MembershipState report9 = createRegistration(
//                "hz-cluster11", "nn_1_1", "hadoop3897.jd.163.org_8020","hadoop3897.jd.163.org:8025",
//                FederationNamenodeServiceState.ACTIVE);
//        assertTrue(namenodeHeartbeat(report9));
        ...
        // Verify quorum entry uses the newest data, even though it is standby
        MembershipState quorumEntry = getNamenodeRegistration(
                report2.getNameserviceId(), report2.getNamenodeId());
        System.in.read();
        // Verify quorum entry uses the newest data, even though it is standby
    ...
    @Test
    public void testRegistrationNoQuorum3()
            throws InterruptedException, IOException {
    ...
    @Test
    public void testMyRegistrationNoQuorum()
            throws InterruptedException, IOException {
