...
public class TestRouterWithDFSCluster {
    ...
    public void testZK() throws Exception {
        TestingServer zkServer = new TestingServer(new InstanceSpec(new File("D:\\data\\zkData"), 2181, -1, -1, true, -1),true);
        zkServer.start();
        System.in.read();
    }
...
//        cluster.installLocations();
        ...
        cluster.getRouters().get(0).getConf().writeXml(new FileOutputStream(new File("D:\\hadoop-3.3.0-1.1.1\\etc\\hadoop\\core-site.xml")));
        cluster.getRouters().get(0).getConf().writeXml(new FileOutputStream(new File("D:\\project\\neproject\\3.3.0\\ne-hadoop\\hadoop-tools\\hadoop-distcp\\target\\classes\\core-site.xml")));
